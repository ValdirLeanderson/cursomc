...
import com.valdirleanderson.cursomc.domain.Cidade;
import com.valdirleanderson.cursomc.domain.Cliente;
import com.valdirleanderson.cursomc.domain.Endereco;
...
import com.valdirleanderson.cursomc.domain.enums.TipoCliente;
import com.valdirleanderson.cursomc.repositories.CategoriaRepository;
import com.valdirleanderson.cursomc.repositories.CidadeRepository;
import com.valdirleanderson.cursomc.repositories.ClienteRepository;
import com.valdirleanderson.cursomc.repositories.EnderecoRepository;
import com.valdirleanderson.cursomc.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instatiateDataBase() throws ParseException {
		...
		Produto p4 = new Produto(null, "Mesa para escritório", 300.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "12345678909", TipoCliente.PESSOA_FISICA);
		cli1.getTelefones().addAll(Arrays.asList("999999999", "666666666"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apt 303", "Jardim", "23234566", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "83765489", cli1, c2);
